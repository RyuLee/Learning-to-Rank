...
import java.io.OutputStreamWriter;                          //Run Argument: -train testplace\\movies_train_extra.txt -ranker 6 -metric2t NDCG@10 -save testplace\\model\\lambdaMART(train++cos(fv))_model.txt -estop 5 -tree 20                                                                                                                                                                                                                                                                                                  
import java.text.DecimalFormat;								//Test Argument:-rank testplace\\movies_test_extra.txt  -metric2t NDCG@10 -load testplace\\model\\lambdaMART(train++cos(fv))_model.txt -score testplace\\score\\lambdaMART(train++cos(fv))_score.txt
